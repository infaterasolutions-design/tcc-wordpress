...
const path = "C:/Users/sande/Local Sites/tcc/app/public/wp-content/themes/tcc-theme/front-page.php";
let content = fs.readFileSync(path, 'utf8');

const newHtml = `	<!-- The Latest Section -->
...
// Replace from <!-- Trending Section --> up to </section>
const pattern = /<!-- Trending Section -->\s*<!-- Trending Section -->\s*<section class="figma-trending-container container">[\s\S]*?<\/script>\s*<\/section>/;
